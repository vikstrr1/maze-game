...
final Map<int, MazeLevelData> mazeLevels = {
  ...
  2: MazeLevelData(
    ...
    walls: [
      {'pos': Vector2(-400, 100), 'size': Vector2(600, 20)}, 
      {'pos': Vector2(200, -200), 'size': Vector2(20, 300)},
      {'pos': Vector2(-100, -200), 'size': Vector2(300, 20)},
      {'pos': Vector2(-100, -200), 'size': Vector2(20, 200)}, 
    ],
  ),
  3: MazeLevelData(
    startPosition: Vector2(-350, 250),
    ...
    walls: [
      {'pos': Vector2(-250, -100), 'size': Vector2(20, 400)},
      {'pos': Vector2(-100, -300), 'size': Vector2(20, 400)},
      {'pos': Vector2(50, -100), 'size': Vector2(20, 400)}, 
      {'pos': Vector2(200, -300), 'size': Vector2(20, 400)},
    ],
  ),
  4: MazeLevelData(
